...
<div class="flex items-center gap-3">
    ...
    <h1 class="text-2xl font-semibold text-white">Create Event</h1>
</div>
...
<form method="POST" action="{{ route('admin.events.store') }}" class="mt-6 max-w-2xl">
    ...
    <div class="mt-8 flex items-center gap-4">
        <button type="submit" class="rounded-md bg-accent px-6 py-2.5 text-sm font-bold text-white transition hover:bg-accent-light">Create Event</button>
