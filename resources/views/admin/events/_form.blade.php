...
<div class="space-y-5 rounded-2xl bg-dark-100 p-6">
    <h2 class="text-base font-extrabold text-white">Match Details</h2>
    ...
    <div class="grid gap-5 sm:grid-cols-2">
        <div class="sm:col-span-2">
            ...
            <input type="text" name="name" value="{{ old('name', $event->name ?? '') }}" required
                   class="w-full rounded-xl border border-white/10 bg-dark px-3 py-2 text-sm text-white placeholder-gray-600 focus:border-accent focus:ring-2 focus:ring-accent/20 focus:outline-none"
        ...
        <div>
            ...
            <input type="datetime-local" name="event_date" value="{{ old('event_date', isset($event) ? $event->event_date->format('Y-m-d\TH:i') : '') }}" required
                   class="w-full rounded-xl border border-white/10 bg-dark px-3 py-2 text-sm text-white focus:border-accent focus:ring-2 focus:ring-accent/20 focus:outline-none">
        </div>
    </div>
    ...
    <h2 class="text-base font-extrabold text-white">Pricing & Capacity</h2>
